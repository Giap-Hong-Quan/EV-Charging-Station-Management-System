...
//   Future<void> renderStations(List<ChargingStation> stations) async {
...
//   Future<void> flyToStation(ChargingStation station) async {
//     if (_map == null) return;
...
//   Future<void> fitBoundsToStations(List<ChargingStation> stations) async {
...
//   ChargingStation? getStationByAnnotationId(String annotationId) {
